...
import { BUSD, DAI, USDT, BTCB, CAKE, WBNB, UST, ETH, USDC, BBT, KUSDT, KETH } from './tokens'

export const ROUTER_ADDRESS = '0x590Ace72A94D314146aA51EF0EBDD2db00DDB976'
...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.MAINNET]: [KUSDT[ChainId.MAINNET], BBT[ChainId.MAINNET], KETH],
  [ChainId.TESTNET]: [WETH[ChainId.TESTNET], CAKE[ChainId.TESTNET], BUSD[ChainId.TESTNET]],
}
