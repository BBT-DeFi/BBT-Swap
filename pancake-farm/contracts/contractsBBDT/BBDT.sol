...
contract BBDT is  /*IKAP20, Context,Ownable*/ KAP20('BBDT Token', 'BBDT')  { //linearization of inheritance graph impossible comes from the order of inheritance
...
//     }
    ...
    //this is for masterchef to mint >> same as mint funciton in caketoken contract not same as BEP exactly
    ...
    // ----------------this part is from cake token's delegate and votign function
